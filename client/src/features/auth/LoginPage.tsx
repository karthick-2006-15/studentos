    ...
    <div className="min-h-screen w-screen flex items-center justify-center p-4 bg-[#09090b]">
      <div className="w-full max-w-sm space-y-6">
        ...
        <div className="text-center space-y-1.5">
          ...
          <h1 className="text-xl font-semibold tracking-tight text-zinc-100">Sign in to NEXUS</h1>
          <p className="text-xs text-zinc-400">Minimalist AI Student Operating System</p>
        </div>
